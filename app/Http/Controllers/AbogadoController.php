...
class AbogadoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Consulta los usuarios que tienen tipo_usuario igual a 5 y aplicando filtro de búsqueda
        $usersQuery = User::with('tipoDocumento', 'userGroup') // Incluye relaciones
            ->where('tipo_usuario', '=', 5) // Incluye solo usuarios con tipo_usuario igual a 5
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'numero_documento' => 'required|string', // Usar el validador personalizado 'valid_rut'
        ...
        if ($validator->fails()) {
            return redirect()->back()->withErrors($validator)->withInput()->with('abogados.create', true);
        }
        ...
        if ($user->save()) {
            ...
            return redirect('/abogados')->with('success', 'User has been added');
        } else {
    ...
    public function show($id)
    {
        ...
        return view('abogados.show', compact('user'));
    }
    ...
    {
        $user = User::findOrFail($id);
        return view('abogados.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'tipo_documento' => 'required|integer|exists:tipo_documento,id',
            'tipo_usuario' => 'required|integer|exists:user_groups,id',
            'numero_documento' => 'required|string', // Validador personalizado para RUT
            'numero_telefonico' => 'required|digits_between:8,15',
            'profile_photo_path' => 'nullable|image|mimes:jpg,jpeg,gif|max:2048',
        ...
        if ($validator->fails()) {
            return redirect()->back()->withErrors($validator)->withInput()->with('abodagos.edit', true);
        }
        ...
        return redirect('/abogados')->with('success', 'User has been updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/abogados')->with('success', 'User has been deleted');
    }
