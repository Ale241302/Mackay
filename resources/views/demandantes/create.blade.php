...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4">Crear Directorio</h1>

        <form action="{{ route('demandantes.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="empresa_demandante" name="empresa_demandante" class="form-control"
                                placeholder="Nombre Empresa" required value="{{ old('empresa_demandante') }}"
                                maxlength="30" />
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="rut_demandante" name="rut_demandante" class="form-control"
                                placeholder="Número RUT/NIT" required maxlength="15" value="{{ old('rut_demandante') }}" />
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="email" id="email_demandante" name="email_demandante" class="form-control"
                                placeholder="Correo Electrónico" maxlength="255" value="{{ old('email_demandante') }}" />
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="telefono_demandante" name="telefono_demandante" class="form-control"
                                placeholder="+5063046405009" maxlength="15" value="{{ old('telefono_demandante') }}" />
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="domicilio_demandante" name="domicilio_demandante" class="form-control"
