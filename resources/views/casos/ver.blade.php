                                ...
                                <div class="col">
                                    <div data-mdb-input-init class="form-outline">
                                        ...
                                        <input type="email" id="email_demandante" name="email_demandante"
                                            ...
                                            readonly value="{{ old('email_demandante', $caso->email_demandante) }}" />
                                ...
                                <div class="col">
                                    <div data-mdb-input-init class="form-outline">
                                        ...
                                        <input type="text" id="telefono_demandante" name="telefono_demandante"
                                            class="form-control" placeholder="+5063046405009" maxlength="15" readonly
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="number" id="referencia_caso" name="referencia_caso" class="form-control"
                                    ...
                                    value="{{ old('referencia_caso', $caso->referencia_caso) }}" maxlength="30" />
                                        ...
                                        <div data-mdb-input-init class="form-outline">
                                            ...
                                            <div class="form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="cobrofijo"
                                                    ...
                                                    @checked($caso->cobrofijo == 1) disabled>
                                        ...
                                        <div data-mdb-input-init class="form-outline">
                                            ...
                                            <div class="form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="cobrohora"
                                                    ...
                                                    @checked($caso->cobrohora == 1) disabled>
                                                <!-- Agrega el atributo disabled aquí -->
                                        ...
                                        <div data-mdb-input-init class="form-outline">
                                            ...
                                            <div class="form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="cobroporciento"
                                                    ...
                                                    @checked($caso->cobroporciento == 1) disabled>
                                                <!-- Agrega el atributo disabled aquí -->
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="number" id="id" name="id" class="form-control" placeholder="111"
                                readonly value="{{ old('id', $caso->id) }}" maxlength="30" />
                            @error('id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <select id="tipo_caso" name="tipo_caso" class="form-control" disabled>
                                <option value="" selected>Seleccione un tipo de caso</option>
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    ...
                                    <input type="datetime-local" id="fecha_hora" name="fecha_hora"
                                        max="{{ now()->format('Y-m-d\TH:i') }}" class="form-control" readonly>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" id="horas_trabajadas" name="horas_trabajadas"
                                        class="form-control" readonly min="0" step="0.1">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <select id="realizada" name="realizada" class="form-control" readonly>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    ...
                                    <input type="file" id="documento_documentos" name="documento_documentos"
                                        class="form-control" readonly accept=".pdf,.rar,.zip,.docx,.xls">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col">
                                    ...
                                    <select id="origen" name="origen" class="form-control" readonly>
                        ...
                        <form id="CarpetaForm" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <!-- Realizada -->
                                    <label for="origen" class="form-label">Origen</label>
                                    <select id="origen2" name="origen" class="form-control" readonly>
                                        <option value="Tribunal" {{ old('origen') == 'Tribunal' ? 'selected' : '' }}>
                                            Tribunal
                                        </option>
                                        <option value="Correos" {{ old('origen') == 'Correos' ? 'selected' : '' }}>
