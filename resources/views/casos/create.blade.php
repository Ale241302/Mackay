...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4">Crear Caso</h1>
                                ...
                                <div class="col">
                                    <div data-mdb-input-init class="form-outline">
                                        ...
                                        <input type="text" id="rut" name="rut" class="form-control"
                                            placeholder="Número RUT/NIT" maxlength="15" value="{{ old('rut') }}"
                                            readonly />
                                        @error('rut')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="number" id="cuantia" name="cuantia" class="form-control"
                                    placeholder="3.000" min="0" step="0.01" value="{{ old('cuantia') }}" />
                                @error('cuantia')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
            ...
            fetch(`/casos/crear-carpeta`, {
                ...
                .then(data => {
                    ...
                    <tr data-id2="${documentoObj.id}">
                        ...
                        <td>${nombredoc}</td>
                        <td>
                        <a href="/storage/${nombredoc}" target="_blank">
                            <i class="fas fa-folder"></i> ${nombredoc}
                        </a>
                    </td>
                        <td>${origen}</td>
                        <td>
