...
@section('content')
    <div class="container">
        <h1 class="flex-grow-1 text-center mb-0">Monto Hora</h1>
        <br />
        @if (in_array(46, $permisosUsuario))
            <!-- Habilita el botón de crear solo si el usuario tiene el permiso correspondiente -->
            <div class="d-flex justify-content-end">
                <a href="{{ route('montohora.create') }}" class="btn btn-primary"
                    style="background-color: #1814F3; border-color: #1814F3;">+ Nuevo Monto</a>
            </div>
        @endif
        <br />
        <form id="search-form" action="{{ route('montohora.index') }}" method="GET" class="mb-3">
            <br />
                    ...
                    @foreach ($userGroups as $userGroup)
                        <tr>
                            @if (in_array(45, $permisosUsuario))
                                ...
                                <td style="text-align: center">{{ $userGroup->monto }}</td>
                            @endif
                            <td class="action-buttons d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2"
                                    ...
                                    @if (in_array(47, $permisosUsuario))
                                        <!-- Botón de editar -->
                                        <a href="{{ route('montohora.edit', $userGroup->id) }}" class="btn btn-warning me-2"
                                    ...
                                    @if (in_array(48, $permisosUsuario))
                                        ...
                                        @else
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                ...
                                                data-action="{{ route('montohora.destroy', $userGroup->id) }}">
