...
@section('content')
    <div class="container">
        <h1 class="flex-grow-1 text-center mb-0">Tipo Casos</h1>
        <br />
        @if (in_array(18, $permisosUsuario))
            <!-- Habilita el botón de crear solo si el usuario tiene el permiso correspondiente -->
            <div class="d-flex justify-content-end">
                <a href="{{ route('tipocaso.create') }}" class="btn btn-primary"
                    style="background-color: #1814F3; border-color: #1814F3;">+ Nuevo Tipo de Caso</a>
            </div>
        @endif
        <br />
        <form id="search-form" action="{{ route('tipocaso.index') }}" method="GET" class="mb-3">
            <br />
                            ...
                            <td class="action-buttons d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    @if (in_array(19, $permisosUsuario))
                                        <!-- Botón de editar -->
                                        <a href="{{ route('tipocaso.edit', $userGroup->id) }}" class="btn btn-warning me-2"
                                    ...
                                    @if (in_array(20, $permisosUsuario))
                                        ...
                                        @else
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                ...
                                                data-action="{{ route('tipocaso.destroy', $userGroup->id) }}">
