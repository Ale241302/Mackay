...
@section('content')
    <div class="container">
        <h1 class="flex-grow-1 text-center mb-0">Etapa Procesal</h1>
        <br />
        @if (in_array(42, $permisosUsuario))
            <!-- Habilita el botón de crear solo si el usuario tiene el permiso correspondiente -->
            <div class="d-flex justify-content-end">
                <a href="{{ route('tipoprocesal.create') }}" class="btn btn-primary"
                    style="background-color: #1814F3; border-color: #1814F3;">+ Nueva Etapa Procesal</a>
            </div>
        @endif
        <br />
        <form id="search-form" action="{{ route('tipoprocesal.index') }}" method="GET" class="mb-3">
            <br />
                            ...
                            <td class="action-buttons d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    @if (in_array(43, $permisosUsuario))
                                        <!-- Botón de editar -->
                                        <a href="{{ route('tipoprocesal.edit', $userGroup->id) }}"
                                    ...
                                    @if (in_array(44, $permisosUsuario))
                                        ...
                                        @else
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                ...
                                                data-action="{{ route('tipoprocesal.destroy', $userGroup->id) }}">
