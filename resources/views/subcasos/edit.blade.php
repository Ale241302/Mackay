...
@section('content')
    <div class="container">
        ...
        <form id="editUsersForm" action="{{ route('subcasos.update', $subcaso->id) }}" method="POST"
                                ...
                                <div class="col">
                                    <div data-mdb-input-init class="form-outline">
                                        ...
                                        <input type="email" id="email_demandante" name="email_demandante"
                                            ...
                                            value="{{ old('email_demandante', $subcaso->email_demandante) }}" />
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="number" id="referencia_caso" name="referencia_caso" class="form-control"
                                    placeholder="111" value="{{ old('referencia_caso', $subcaso->referencia_caso) }}"
                                    maxlength="30" />
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="text" id="descripcion_caso" name="descripcion_caso" class="form-control"
                                    placeholder="descripcion del caso" maxlength="255"
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="text" id="asunto_caso" name="asunto_caso" class="form-control"
                                    placeholder="Asunto" maxlength="15"
                                        ...
                                        <div data-mdb-input-init class="form-outline">
                                            ...
                                            <div class="form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="cobroporciento"
                                                    ...
                                                    @checked($subcaso->cobroporciento == 1)>
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="id" name="id" class="form-control" placeholder="111"
                                required value="{{ old('id', $subcaso->refsub) }}" maxlength="30" />
                            @error('id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
