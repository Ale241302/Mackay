                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <select id="casos" name="caso" class="form-control"
                                    ...
                                    <option value="" {{ is_null($casoPadreId) ? 'selected' : '' }}>Seleccione un caso
                                    </option>
                                    @foreach ($casosActivos as $casosActivo)
                                        <option value="{{ $casosActivo->id }}" data-empresa="{{ $casosActivo->empresa }}"
                                            ...
                                            data-descripcion-caso="{{ $casosActivo->descripcion_caso }}"
                                            data-asunto-caso="{{ $casosActivo->asunto_caso }}"
                                            data-abogados="{{ $casosActivo->abogados }}"
                                            data-tipo-caso="{{ $casosActivo->tipo_caso }}"
                                            data-referencia-caso="{{ $casosActivo->referencia_caso }}"
                                            data-telefono-demandante="{{ $casosActivo->telefono_demandante }}"
                                            data-cobrofijo="{{ $casosActivo->cobrofijo }}"
                                            data-cobrohora="{{ $casosActivo->cobrohora }}"
                                            data-cobroporciento="{{ $casosActivo->cobroporciento }}"
                                            data-rol-caso="{{ $casosActivo->rol_caso }}"
                                            data-tribunal="{{ $casosActivo->tribunal }}"
                                            data-juez-civil="{{ $casosActivo->juez_civil }}"
                                            data-juez-arbitro="{{ $casosActivo->juez_arbitro }}"
                                            data-rol-arbitral="{{ $casosActivo->rol_arbitral }}"
                                            data-tipo-moneda="{{ $casosActivo->tipo_moneda }}"
                                            data-monto-hora="{{ $casosActivo->monto_hora }}"
                                            data-nombre-juicio="{{ $casosActivo->nombre_juicio }}"
                                            data-demandante="{{ $casosActivo->demandante }}"
                                            data-bill="{{ $casosActivo->bill }}" data-fechai="{{ $casosActivo->fechai }}"
                                            data-fechait="{{ $casosActivo->fechait }}"
                                            data-referencia-demandante="{{ $casosActivo->referencia_demandante }}"
                                            {{ old('caso') == $casosActivo->id || $casoPadreId == $casosActivo->id ? 'selected' : '' }}>
                                            {{ $casosActivo->id }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col">
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <input type="text" id="asunto_caso" name="asunto_caso" class="form-control"
                                    placeholder="Asunto" maxlength="255" value="{{ old('asunto_caso') }}" />
                                @error('asunto_caso')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <select id="tipo_caso" name="tipo_caso" class="form-control">
                    ...
                    <div class="col">
                        ...
                        <select id="etapa_procesal" name="etapa_procesal" class="form-control">
                            <option value="" disabled selected>Seleccione un tipo de caso</option>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchCasoData(selectElement) {
                ...
                const descripcionCaso = selectedOption.getAttribute('data-descripcion-caso');
                const asuntoCaso = selectedOption.getAttribute('data-asunto-caso');
                const fechai = selectedOption.getAttribute('data-fechai');
                const fechait = selectedOption.getAttribute('data-fechait');

                const tipoCaso = selectedOption.getAttribute('data-tipo-caso');
                const cobroFijo = selectedOption.getAttribute('data-cobrofijo');
                const cobroHora = selectedOption.getAttribute('data-cobrohora');
                const cobroPorciento = selectedOption.getAttribute('data-cobroporciento');

                const juezCivil = selectedOption.getAttribute('data-juez-civil');
                const juezArbitro = selectedOption.getAttribute('data-juez-arbitro');

                const tipoMoneda = selectedOption.getAttribute('data-tipo-moneda');

                const nombreJuicio = selectedOption.getAttribute('data-nombre-juicio');
                const demandante = selectedOption.getAttribute('data-demandante');

                const referenciaDemandante = selectedOption.getAttribute('data-referencia-demandante');
                const referenciaCaso = selectedOption.getAttribute('data-referencia-caso');

                const abogados = selectedOption.getAttribute('data-abogados') ? JSON.parse(selectedOption
                    .getAttribute('data-abogados')) : [];
                const tribunal = selectedOption.getAttribute('data-tribunal') ? JSON.parse(selectedOption
                    .getAttribute('data-tribunal')) : [];
                const rolCaso = selectedOption.getAttribute('data-rol-caso') ? JSON.parse(selectedOption
                    .getAttribute('data-rol-caso')) : [];
                const rolArbitral = selectedOption.getAttribute('data-rol-arbitral') ? JSON.parse(selectedOption
                    .getAttribute('data-rol-arbitral')) : [];
                const bill = selectedOption.getAttribute('data-bill') ? JSON.parse(selectedOption.getAttribute(
                    'data-bill')) : [];
                ...
                document.getElementById('descripcion_caso').value = descripcionCaso || '';
                document.getElementById('asunto_caso').value = asuntoCaso || '';
                document.getElementById('juez_civil').value = juezCivil || '';
                document.getElementById('juez_arbitro').value = juezArbitro || '';
                document.getElementById('fechai').value = fechai || '';
                document.getElementById('fechait').value = fechait || '';
                document.getElementById('referencia_demandante').value = referenciaDemandante || '';
                document.getElementById('referencia_caso').value = referenciaCaso || '';
                document.getElementById('tipo_caso').value = tipoCaso || '';
                document.getElementById('cobrofijo').checked = cobroFijo === "1";
                document.getElementById('cobrohora').checked = cobroHora === "1";
                document.getElementById('cobroporciento').checked = cobroPorciento === "1";
                document.getElementById('nombre_juicio').value = nombreJuicio || '';
                document.getElementById('tipo_moneda').value = tipoMoneda || '';
                document.getElementById('demandante').value = demandante || '';

                // Actualizar los labels de los toggles
                toggleLabel(document.getElementById('cobrofijo'), 'label-cobrofijo');
                toggleLabel(document.getElementById('cobrohora'), 'label-cobrohora');
                toggleLabel(document.getElementById('cobroporciento'), 'label-cobroporciento');

                // Para los select múltiples (Abogados y Tribunal)
                setMultipleSelectValues('abogados', abogados);
                setMultipleSelectValues('tribunal', tribunal);
            ...
            function setMultipleSelectValues(selectId, valuesArray) {
                const selectElement = document.getElementById(selectId);
                const options = selectElement && selectElement.options;

                if (options) {
                    for (let i = 0; i < options.length; i++) {
                        options[i].selected = valuesArray.includes(options[i].value);
                    }
                }
            }
            ...
            // Agregar etiquetas al contenedor desde el input
