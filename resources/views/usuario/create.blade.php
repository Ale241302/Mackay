                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        ...
                        <input type="date" id="fechan" name="fechan" class="form-control" required
                            max="{{ date('Y-m-d') }}" value="{{ old('fechan') }}" />
            ...
            <div class="row mb-4">
                    ...
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="numero_telefonico" name="numero_telefonico" class="form-control"
                                placeholder="Número Telefónico" required maxlength="15"
                                value="{{ old('numero_telefonico') }}" oninput="validatePhoneNumber(this)" />
                ...
                <div data-mdb-input-init class="form-outline">
                    ...
                    <input type="file" id="profile_photo_path" name="profile_photo_path" class="form-control"
                        accept=".jpg, .jpeg, .gif" value="{{ old('profile_photo_path') }}"
